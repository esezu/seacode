...
class HomeController {
    ...
    public function __construct() {
        ...
        $this->moban = $this->f3->get('MOBAN');
        $this->apiBase = $this->f3->get('API_BASE');
        $this->playBase = $this->f3->get('PLAY_BASE');
    }
    ...
    public function beforeRoute() {
        // 加载分类数据到全局变量
        $categories = $this->getCategories($this->f3);
    ...
    {
        $typeId = $f3->get('PARAMS.type_id', 0);
